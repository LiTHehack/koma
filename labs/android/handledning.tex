...
%
%
% FIXME – instruktioner för att komma igång
%
%
%
%
...
Du kan också ställa markören i det rödmarkerade ListActivity och trycka Alt+Enter för att få upp denna meny. \\ % FIXME – stämmer detta på windows?
...
I argumenten för \textit{onListItemClick} så finns den aktuella postens index i konstanten \textit{id}.\\ % FIXME - är det verkligen i ID? Inte position?
